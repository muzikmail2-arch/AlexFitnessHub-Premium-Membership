...
export default function CustomProgramBuilder({ onClose, onSuccess, setView }: CustomProgramBuilderProps) {
        ...
        <div className="flex flex-col sm:flex-row gap-3 justify-center items-center pt-2">
          ...
          <button
            onClick={() => {
              onClose();
              setView?.("pricing");
            }} // Let them trigger direct billing or read premium highlights
